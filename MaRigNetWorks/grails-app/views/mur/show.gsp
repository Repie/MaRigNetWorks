			...
			<ol class="property-list mur">
				...
				<li class="fieldcontain">
					<span id="proprietaire-label" class="property-label"><g:message code="mur.proprietaire.label" default="Proprietaire" /></span>
						...
						<span class="property-value" aria-labelledby="proprietaire-label"><g:link controller="membre" action="show" id="${murInstance?.proprietaire?.id}">${murInstance?.proprietaire?.encodeAsHTML()}</g:link></span>
